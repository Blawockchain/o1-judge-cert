...
export default function ResultsPage() {
  ...
  function shareLinkedIn() {
    const text = encodeURIComponent(
      `Honored to share that I've been recognized for extraordinary ability through the Dunki Judgeathon 2026. My contributions as a judge have been formally acknowledged. #Judgeathon #OnlyJudges`
    );
    window.open(
      `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://judgeathon.devfolio.co")}&summary=${text}`,
      "_blank"
    );
  }
  ...
  async function downloadPDF(type: "approval" | "flight" | "certificate") {
    ...
    if (type === "approval") {
      ...
      doc.setFontSize(14);
      doc.text("DUNKI TECHNOLOGIES, INC.", 105, 25, { align: "center" });
      ...
      doc.text("Classification: Extraordinary (Self-Assessed)", 20, y + 24);
      doc.text("Expiry Date: April 2, 2026", 20, y + 32);
      doc.text("Issued by: Dunki Technologies, Inc.", 20, y + 40);

      const textY = y + 56;
      doc.text("Dear " + judgeName + ",", 20, textY);
      const body = `This notice confirms that Dunki Technologies, Inc. has reviewed your judging contributions and hereby recognizes your extraordinary ability in the field of technology evaluation.

Your participation in the Dunki Judgeathon 2026 has been assessed and found to demonstrate exceptional merit in:
...
Dunki Technologies, Inc.`;
      ...
      doc.setFontSize(18);
      doc.text("🧊 Airways", 105, 30, { align: "center" });
      doc.setFontSize(8);
      ...
      doc.setFontSize(6);
      doc.text(
        "🧊 Airways is a fictional airline. No actual flight is provided. This voucher is for entertainment purposes only. Valid April 2, 2026.",
        105, 285, { align: "center" }
      );
      ...
      doc.setFont("times", "normal");
      doc.setFontSize(11);
      const certBody = `has demonstrated extraordinary ability in the evaluation of technology projects through participation in the Dunki Judgeathon 2026. Their expert assessments have contributed to the advancement of innovation in the global technology ecosystem.

Classification: Extraordinary (Self-Assessed)
...
Reference: ${caseNumber}`;
      ...
      doc.text("Dunki Technologies", 60, 195);
      ...
      <section className="relative overflow-hidden bg-[#002868] py-24 px-6">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-lg text-blue-200 mb-8">
            Your extraordinary ability has been officially recognized
          </motion.p>
          <motion.p variants={fadeUp} className="text-sm text-blue-300 mb-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 text-sm mb-10 bg-white/60 p-5 border border-amber-100/50">
            ...
            <div>
              ...
              <p className="font-semibold text-[#002868]">Extraordinary (Self-Assessed)</p>
            </div>
            <div>
              <p className="text-[10px] text-gray-400 uppercase tracking-wider font-mono-accent">Issued By</p>
              <p className="font-semibold text-[#002868]">Dunki Technologies, Inc.</p>
            </div>
            <div>
          ...
          <div className="text-sm text-gray-700 space-y-4 leading-relaxed font-serif">
            <p>Dear {judgeName},</p>
            <p>
              Dunki Technologies, Inc. hereby confirms that your contributions as a judge in the
            ...
            <p>
              Please retain this notice. Your 🧊 Airways boarding pass has been prepared and
            ...
            <div className="text-sm">
              ...
              <div className="mt-8">
                ...
                <div className="border-t border-amber-300 pt-1 w-48">
                  ...
                  <p className="text-xs text-gray-400">Dunki Technologies, Inc.</p>
                </div>
              </div>
            </div>
            {/* Seal */}
      ...
      <section className="py-14 px-6 bg-white">
        <div className="max-w-3xl mx-auto flex justify-center">
          <motion.button
            ...
            className="btn-primary py-4 text-sm px-10"
