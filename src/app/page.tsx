        ...
        <section className="py-20 px-6 bg-white border-b border-gray-200">
          <div className="max-w-5xl mx-auto">
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.div variants={fadeUp} className="grid grid-cols-2 sm:grid-cols-5 gap-6 max-w-6xl mx-auto">
                {/* Devfolio */}
                <a
                ...
                {/* AI & Weekends */}
                <a
                  href="https://aiweekends.xyz"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="card flex flex-col items-center justify-center py-10 gap-4 hover:border-[#B22234]/30 transition-all group"
                >
                  <img
                    src="/aiweekends-logo.jpg"
                    alt="AI & Weekends"
                ...
                >
                  ...
                  />
                  <div className="text-center">
                    <p className="font-serif font-bold text-lg text-[#002868]">Zo</p>
                    <p className="text-xs text-gray-400 mt-0.5">zo.xyz</p>
                  </div>
                </a>
                {/* Inner Circle */}
                <a
